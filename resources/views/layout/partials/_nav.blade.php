            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="laracast.com">Laracasts</a></li>
                        <li><a href="larajobs.com">Larajobs</a></li>
                        <li><a href="laravel-news.com">Laravel news</a></li>
                        <li><a href="larachat.co">Larajob</a></li>
                    </ul>
                </li>
