...
@section('content')
    <div class="container">
        ...
        <p> Feel free to help to improve the <a href="https://github.com/Maxime001/Laracarte">source code</a>.</p>

        <hr>

        <h2>What is laramap</h2>
        <p>Laramap is the website by which Laracart was inspired</p>
        <p>More info <a href="https://laramap.com/p/about">Here</a> </p>

        <hr>

        <h2>Which tools and services are user in {{config('app.name') }} ? </h2>
